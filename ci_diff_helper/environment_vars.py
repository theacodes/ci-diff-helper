...
KOKORO_GITHUB_PULL_REQUEST_URL = 'KOKORO_GITHUB_PULL_REQUEST_URL'
...
KOKORO_GITHUB_COMMIT_URL = 'KOKORO_GITHUB_COMMIT_URL'
...
KOKORO_GERRIT_BRANCH = 'GERRIT_BRANCH'
...
KOKORO_GERRIT_CHANGE_NUMBER = 'GERRIT_CHANGE_NUMBER'
